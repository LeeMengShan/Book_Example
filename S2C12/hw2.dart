...
void main() async {
  ...
  List<dynamic> jsonArrayResponse = await getRemoteSystemData('https://jsonplaceholder.typicode.com/comments');
  // 印出第五個json object
  print(jsonArrayResponse[4]);
  
  
  // 調度postRemoteSystemData函數，並等待其傳回的Future完成
  String jsonArrayResponse2 = await postRemoteSystemData('https://jsonplaceholder.typicode.com/comments');
  // 印出資料編號的id
